 ...
 * The Class addBookToDB runs a query to add book with one author to database
 */
public class addBookToDB{

	    private static initConnection con;
        /**
        * The method addBook2ToDB runs a query to add book with one author to database
        ...
        */
		public static void addBookToDB(String author,String Title,String language,String plot,String subject,String scope,String price,String Table_of_Contents,String urlPDF,String urlDOC,dbInfo info) throws Exception{
			try {
			...
			try{	    	
		    	String insertSql1 = "INSERT INTO ibook.book(author,title,plot,price,Table_of_Contents,url_pdf,url_doc,language) values(?,?,?,?,?,?,?,?)";
		    	...
		    	statement1.setString(8, language);
